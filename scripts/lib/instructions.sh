...
show_cgroup_instructions() {
    ...
    if [ -n "$boot_config" ]; then
        echo "  Your system uses: ${GREEN}$boot_config${NC}"
        echo ""
        echo "  Edit the file:"
        echo -e "    ${BLUE}sudo nano $boot_config${NC}"
    else
        echo "  ${YELLOW}⚠ Could not auto-detect boot config file.${NC}"
        echo ""
...
show_low_ram_warning() {
    ...
    echo -e "${RED}└────────────────────────────────────────────────────────────┘${NC}"
    echo ""
    echo "Your system has ${RED}${detected}GB${NC} RAM"
    echo "Minimum required: ${GREEN}${required}GB${NC} RAM"
    echo ""
...
show_low_disk_warning() {
    ...
    echo -e "${RED}└────────────────────────────────────────────────────────────┘${NC}"
    echo ""
    echo "Free disk space: ${RED}${detected}GB${NC}"
    echo "Minimum required: ${GREEN}${required}GB${NC}"
    echo ""
    ...
    echo "  2. Clean up unnecessary files: ${BLUE}sudo apt clean && sudo apt autoremove${NC}"
