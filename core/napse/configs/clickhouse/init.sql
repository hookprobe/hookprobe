...
-- ============================================================================
-- SENTINEL TEMPORAL & CAMPAIGN TABLES
-- Previously created dynamically by temporal_memory.py and sentinel_lifecycle.py
-- ============================================================================

-- Temporal drift analysis per-IP: behavioral changes over time.
...
-- Coordinated campaign detection: groups of co-occurring attack sources.
...
-- SENTINEL lifecycle metrics: model performance tracking over time.
