#!/usr/bin/env python3
"""
WiFi Channel Scanner - Intelligent Channel Selection
...
class ScanResult:
    ...
    channel_scores: Dict[int, ChannelInfo]
...
class WiFiChannelScanner:
    ...
    def _calculate_channel_scores(self) -> Dict[int, ChannelInfo]:
    ...
    def _calculate_single_channel_score(self, channel: int, band: Band) -> ChannelInfo:
        """
    ...
    def _find_best_channel(self, scores: Dict[int, ChannelInfo], band: Band) -> int:
